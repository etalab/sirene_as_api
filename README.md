...
#### Mise à jour au 05/08/19 :
L'API renvoie pour le moment les données modifiées des fichiers INSEE V3 vers INSEE V2. Nous travaillons à la prochaine version qui nous permettra de renvoyer les données à jour.
Attention, la nouvelle version nécessitera  de drop puis réinstaller la base de donnée.

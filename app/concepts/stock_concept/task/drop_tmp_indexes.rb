class StockConcept
  module Task
    class DropTmpIndexes < Trailblazer::Operation
      ...
      step :drop_indexes, id: :drop_unite_legale_indexes
      step :log_indexes_dropped, id: :log_unite_legale_indexes_dropped

      step :table_name_etablissement
      step :drop_indexes, id: :drop_etablissement_indexes
      step :log_indexes_dropped, id: :log_etablissement_indexes_dropped

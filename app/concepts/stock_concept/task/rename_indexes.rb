class StockConcept
  module Task
    class RenameIndexes < Trailblazer::Operation
      include StockConcept::Helper::DatabaseIndexes

      step :table_name_unite_legale
      step :rename_indexes, id: :rename_unite_legale_indexes
      step :log_indexes_renamed, id: :log_unite_legale_indexes_renamed

      step :table_name_etablissement
      step :rename_indexes, id: :rename_etablissement_indexes
      step :log_indexes_renamed, id: :log_etablissement_indexes_renamed

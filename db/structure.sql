...
--
-- Name: etablissements_v3; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.etablissements_v3 (
    id integer NOT NULL,
    siren character varying,
    nic character varying,
    siret character varying,
...
--
-- Name: etablissements_v3_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.etablissements_v3_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: etablissements_v3_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.etablissements_v3_id_seq OWNED BY public.etablissements_v3.id;
...
--
-- Name: etablissements_v3 id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.etablissements_v3 ALTER COLUMN id SET DEFAULT nextval('public.etablissements_v3_id_seq'::regclass);
...
--
-- Name: etablissements_v3 etablissements_v3_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.etablissements_v3
    ADD CONSTRAINT etablissements_v3_pkey PRIMARY KEY (id);
...
--
-- Name: index_etablissements_v3_on_siren; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_etablissements_v3_on_siren ON public.etablissements_v3 USING btree (siren);


--
-- Name: index_etablissements_v3_on_siret; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_etablissements_v3_on_siret ON public.etablissements_v3 USING btree (siret);
